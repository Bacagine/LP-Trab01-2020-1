...
/* Função que lê os nomes dos países. O 1o argumento da
...
/* Função que lê a matriz de contágios. O 1o argumento da
função é o número de países, o 2o argumento é o número
...
país. O 1o argumeto da função é o número de dias, o 2o
argumento é a matriz de contágios e o 3o argumento é
...
de contágios em um país. O 1o argumeto da função é o
número de dias, o 2o argumento é a matriz de contágios,
o 3o argumento é o índice na matriz de contágios que
representa o país dia de maior contágio e o número de
contágio deseja-se obter, o 4o argumento é um parâmetro de
saída usado para devolver o dia com maior número de contágios
e o 5o argumento é outro parâmetro de saída usado para
devolver o maior número de contágios. */
void dia_maior_contagio_pais(int, int [][*], int, int *, int *);

/* Função que devolve o dia de maior contágios e o número
de contágios em todos os países. O 1o argumeto da função
é o número de países, o 2o argumento é o número de dias,
o 3o argumento é a matriz de contágios, o 4o argumento
é um parâmetro de saída usado para devolver o dia com maior
número de contágios e o 5o argumento é outro parâmetro de
...
de contágios em um país. O 1o argumeto da função é o número
de dias, o 2o argumento é a matriz de contágios e o 3o argumento
